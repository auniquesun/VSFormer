...
from datasets.data import RGBD_SingleView, RGBD_MultiView
...
def entry(rank, num_devices):
    ...
    if args.stage_one:
        ...
        # --- 2. construct model
        if 'resnet18' in args.base_model_name: weights = ResNet18_Weights.DEFAULT 
    ...
    if args.stage_two:
        ...
        mv_classifier = VSFormer(sv_classifier.feature_extractor, base_model_name=args.base_model_name,
                                            ...
                                            num_views=args.num_views, clshead_layers=args.clshead_layers, 
                                            num_classes=args.num_obj_classes, use_cls_token=args.use_cls_token, 
                                            use_max_pool=args.use_max_pool, use_mean_pool=args.use_mean_pool, 
                                            use_pos_embs=args.use_pos_embs).to(rank)
