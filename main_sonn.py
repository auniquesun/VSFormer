...
from datasets.data import SONN_SingleView, SONN_MultiView
...
def entry(rank, num_devices):
    ...
    if args.stage_one:
        # --- 1. prepare data 
        sv_train_set = SONN_SingleView(args.train_path, scale_aug=False, rot_aug=False, num_classes=args.num_obj_classes)
        ...
        sv_test_set = SONN_SingleView(args.test_path, scale_aug=False, rot_aug=False, test_mode=True, num_classes=args.num_obj_classes)
    ...
    if args.stage_two:
        # --- 1. prepare data
        mv_train_set = SONN_MultiView(args.train_path, scale_aug=False, rot_aug=False, num_views=args.num_views, 
        ...
        mv_test_set = SONN_MultiView(args.test_path, scale_aug=False, rot_aug=False, num_views=args.num_views, 
