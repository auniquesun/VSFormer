# optimize VSFormer on SONN with 
...
PROJ_NAME=vf_naive_sonn
EXP_NAME=SONN-V20-L4H8D512-MR2-Alex-1
MAIN_PROGRAM=main_sonn.py
...
TRAIN_PATH=data/sonn_objonly
TEST_PATH=data/sonn_objonly
NUM_CLASSES=15
NUM_VIEWS=20
BATCH_SIZE=300
BASE_MODEL_BATCH_SIZE=4800
PRINT_FREQ=7
NUM_WORKERS=2
...
pueue add -g ${PROJ_NAME} python ${MAIN_PROGRAM} \
    ...
    --resume --base_model_weights runs/${TASK}/${PROJ_NAME}/SO-objonly-V20-L4H8D512-MR2-Alex-1/weights/sv_model_best.pth \
    --num_views ${NUM_VIEWS} \
    --epochs 300 \
