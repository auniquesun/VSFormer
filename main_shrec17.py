...
from datasets.data import ShapeNetCore55_SingleView, ShapeNetCore55_MultiView
...
def entry(rank, num_devices):
    ...
    if args.stage_two:
        # --- 1. prepare data
        mv_train_set = ShapeNetCore55_MultiView(label_file=args.train_label, version=args.shrec_version, 
        ...
        mv_test_set = ShapeNetCore55_MultiView(label_file=args.test_label, version=args.shrec_version, 
                    num_views=args.num_views, total_num_views=args.total_num_views, num_classes=args.num_obj_classes)
